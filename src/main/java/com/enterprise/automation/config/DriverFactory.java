...
import com.enterprise.automation.config.FrameworkConfig.Web;
...
public class DriverFactory {
    ...
    public WebDriver getDriver() {
        if (driverThread.get() == null) {
            Web webConfig = config.getWeb();
            String browser = webConfig.getBrowser().toLowerCase();
            ...
            log.info("Initialized {} WebDriver in {} mode", browser, headless ? "headless" : "headed");
        }
